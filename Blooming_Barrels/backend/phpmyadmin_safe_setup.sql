-- ==============================================
-- SAFE ROLE MANAGEMENT SETUP FOR PHPMYADMIN
-- This version works with existing table structure
-- ==============================================

-- Step 1: Clean up conflicting tables
DROP TABLE IF EXISTS role_permissions;
DROP TABLE IF EXISTS permissions;

-- Step 2: Clean up the roles table safely
...
SELECT 'ROLES:' as info, id, name, description FROM roles ORDER BY id;
SELECT 'TOTAL PERMISSIONS:' as info, COUNT(*) as count FROM permissions;
SELECT 'ROLE ASSIGNMENTS:' as info, r.name as role_name, COUNT(rp.permission_id) as permission_count
FROM roles r
